...
public class MobileNumberAlreadyExistsException extends RuntimeException {
	...
	public MobileNumberAlreadyExistsException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
	...
	public MobileNumberAlreadyExistsException(String message, Throwable cause, boolean enableSuppression,
